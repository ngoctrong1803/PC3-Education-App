...
router.patch("/:id", getTest, async (req, res) => {
  if (req.body.title != null) {
    res.test1.title /*  res.test1 is in middleware: getTest */ =
      req.body.title; /* client send to server */
  }
  if (req.body.description != null) {
    res.test1.description /*  res.test1 is in middleware: getTest */ =
      req.body.description; /* client send to server */
  }
  try {
